...
**TODO**: For the methodology section, it is also essential to justify the statistical methods that you will be using in your analyses to answer your research question, so that researchers go into the results section with no doubts about the appropriateness of your choices.

### Project Goal and Success

**TODO**: 

* describe and justify why you ran a chi-squared test and what information this test will provide you in context of supporting your larger question/hypotheses. There could also be greater explanation of the individual steps you took before completing the overall chi-squared test: for instance, you could explain/justify the specific variables you chose to include such as “used_goal_real_tier”--what does this variable mean and how does the classification into tiers with your mutated variable relate to the larger analysis on goal v. success rate? This will make it easier for the reader to follow along and allow you to have methods with enough detail such that they can be reproducible.
* in the “project goals and success” section, you say that “this means we reject the null hypothesis that success rates for projects with bigger money is equal or higher than projects with lower money.” Saying you have enough evidence to reject the null is good, but it’s also useful to say that you have sufficient evidence to suggest that your alternative hypothesis is true. 

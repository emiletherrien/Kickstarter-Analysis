...
```{r models}
goal_pledge_mod = lm(success ~ goal data = kickstart_success)
```


**TODO**

* goal amount vs pledge
* categories as interaction effects?
* use regression model
* linear model for number of backers and pledged amount

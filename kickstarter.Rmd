...
*Claim*: The more money the project asks for (project goal), the less successful
it will be in terms of getting funding.

**TODO**: 

We will examine the relationship between the amount of money asked and the success
rate of the project in terms of acquiring the funding.

First, we exclude the ongoing projects because we want to test our hypothesis on
the projects that have been completed to be able to get the accurate success rate.

We decided to choose the variable "used_goal_real_tier" because we noticed that
the amount of money in the usd varied a lot in different projects.A better approach
could be to convert this variable in our data to a categorical variable so that
it is easier for reader to understand what category the goal money falls in when
compared with other projects.

The tiers were rationalized by working with the range of goal-money we saw in the data.
The minimum amount of money asked by the projects was claimed as anything less than
a 1000 dollars, this was our tier 1. We distributed the tier evenly till we reached 
the maximum money ever asked which is 500,000 dollars. This number could be very
large as we aim to cover most of the goals. 

For an easy manipulation of data, we made a new binary variable called "success_state".
...
$H_0$:proportion of people who were  with low money goal - proportion of people who successful with high money <= 0
...
The alternative hypothesis say that there are more or equal proportion
of people who were successful with getting the funding for their projects if the goal

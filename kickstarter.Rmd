...
$H_1$: $p_{less-money}$ > $p_{more-money}$, where $p_{less-money}$ is the proportion of projects that had a lower funding goal and $p_{more-money}$ the proportion of those with a higher goal; $p_{less-money}$ contained Tiers 1-4 and $p_{more-money}$ contained Tiers 5-7

Our alternative hypothesis states that those projects with a lower funding goal will be 
...
chisq.test(table(kickstater_not_live$usd_goal_real_tier, 
                 kickstater_not_live$success_state))
```

At the previously stated $\alpha$ level of 0.05, our p-value is less than 2.2e-16 and thus significant.

Since our p-value is less than our alpha value, we have enough evidence to reject our null hypothesis that the proportion of successful projects in Tiers 1-4 was less than or equal to those in Tiers 5-7.

There is enough evidence to suggest that projects in Tiers 1-4 are more successful in getting funding than those in Tiers 5-7.

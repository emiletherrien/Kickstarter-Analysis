...
* Unify the standard to define what is successful. "Pledged over real" among all states except those are "live". Explain why not using the "state" variable, because it has too many qualifiers that might neglect certain successful obs even though they weren't listed as "successful".

...
Unify the standard to define what is successful. 
* Drop those columns that are "live"
* "Pledged over real"
* "Successful (other anaylyses also use this standard)

How do we sample and what should the size of sample for the bootstraps be?

How to distribute work?

* More work on explorative data analysis
* Can work on Methodology & Discussion together.
* Lots of changes needed for each section, but do we need to keep each section? Is every question meaningful? What do we cut so that in this report we can demonstrate nearly all techniques learned from class? 
* We need to use linear regression for the second to the last section
...
* explain how tiers were defined. rationale.
...
**TODO**: add transition sentence to lead to next section
...
* why is the seed 2?
* explain why you chose certain variables and how you then incorporated those into your hypo test -why omit tier 7?
...
* Come up with a question or claim to study. Doesn't have to be goal amount vs pledge. Can also relate to # backers.
